...
Dept.initColumn = function () {
    var columns = [
        ...
        {title: '类型ID', field: 'deptId', visible: false, align: 'left', valign: 'middle', width: '80px'},
        {title: '类型名称', field: 'name', align: 'left', valign: 'middle', sortable: true, width: '180px'},
        {title: '上级类型', field: 'parentName', align: 'left', valign: 'middle', sortable: true, width: '100px'},
